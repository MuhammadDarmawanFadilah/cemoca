...
export default function BarangPage() {
  ...
  const handleAddNew = () => {
    // Ensure clean state for new item
    handleCloseDialog();
    setIsDialogOpen(true);
  };
            ...
            <div className="space-y-6">
              ...
              {viewingBarang.gambar ? (
                <div className="flex justify-center">
                  <div className="w-80 h-80 relative border rounded-lg overflow-hidden bg-gray-100">
                    {/* Try regular img first for debugging */}
                    <img
                      ...
                      onError={(e) => {
                        console.error('Detail image error for:', `${config.baseUrl}${viewingBarang.gambar}`);
                        const target = e.target as HTMLImageElement;
                        target.style.display = 'none';
                        // Show fallback
                        ...
                        if (parent) {
                          parent.innerHTML = `
                            <div class="w-full h-full flex items-center justify-center bg-gray-50 text-gray-500">
                              <div class="text-center">
                                <div class="text-4xl mb-2">📦</div>
                                <p class="text-sm">Gambar tidak dapat dimuat</p>
                                <p class="text-xs mt-1">${viewingBarang.gambar}</p>
                              </div>
                            </div>
                          `;
                        }
                      ...
                      onLoad={() => {
                        console.log('Detail image loaded successfully:', `${config.baseUrl}${viewingBarang.gambar}`);
                      }}
                    />
                    
                    {/* Overlay for click hint - only shows on hover */}
                ...
                <div className="flex justify-center">
                  <div className="w-80 h-80 border-2 border-dashed border-gray-300 rounded-lg flex items-center justify-center bg-gray-50">
                    <div className="text-center text-gray-500">
                      ...
                      <p className="text-base">Tidak ada gambar</p>
                    </div>
                  </div>
                </div>
              )}
