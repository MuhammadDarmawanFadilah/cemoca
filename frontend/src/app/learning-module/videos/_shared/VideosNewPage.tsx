...
import { buildLearningModuleVideoCodePreview, generateLearningModuleVideoSuffix } from "@/lib/learningModuleVideoCode";
...
export function VideosNewPage(props: {
  basePath: string;
  ...
  const [suffix, setSuffix] = React.useState(() => generateLearningModuleVideoSuffix(6));
  ...
  const onSubmit = async (e: React.FormEvent) => {
    ...
    setSubmitting(true);
    try {
      await learningModuleVideoApi.create({
        title,
            ...
            <div className="w-full max-w-md">
              <div className="relative">
                ...
                <Button
                  ...
                  onClick={() => setSuffix(generateLearningModuleVideoSuffix(6))}
                  disabled={!canRegenerate}
                  aria-label={t("learningModule.video.regenerate")}
                  title={t("learningModule.video.regenerate")}
                >
            ...
            {step === 1 ? (
              <div className="space-y-4">
                ...
                <div className="flex flex-col gap-2 sm:flex-row sm:justify-end">
                  <Button type="button" variant="outline" onClick={() => router.push(props.basePath)}>
                    {t("common.cancel")}
                  </Button>
              ...
              <div className="space-y-4">
                <div className="rounded-lg border bg-muted/10 p-3">
                  <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
                    ...
                    <div className="flex flex-col gap-2 sm:flex-row sm:items-center">
                      ...
                      <Button type="button" onClick={onGenerateIdea} disabled={generatingIdea}>
                ...
                <div className="space-y-2">
                  ...
                  <div className="flex flex-wrap items-center gap-2">
                    ...
                    <Button type="button" variant="outline" size="sm" onClick={() => insertVariable("agentCode")}>
                      :agentCode
                    </Button>
                    <Button type="button" variant="outline" size="sm" onClick={() => insertVariable("companyName")}>
                      :companyName
                    </Button>
                  </div>
                  <Textarea
