  ...
  return (
    <div className="mx-auto w-full max-w-6xl space-y-4 p-4 md:p-6">
      ...
      <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
        <div>
          <h1 className="text-xl font-semibold md:text-2xl">{t("learningModule.video.title")}</h1>
          <p className="text-sm text-muted-foreground">{t("learningModule.video.subtitle")}</p>
        </div>
        <Button asChild>
          <Link href="/learning-module/videos/new">{t("learningModule.video.create")}</Link>
        </Button>
      </div>
                        ...
                        {it.canEdit ? (
                          <>
                            <Button asChild variant="ghost" size="icon" className="h-8 w-8">
                              <Link href={`/learning-module/videos/${it.id}/edit`}>
