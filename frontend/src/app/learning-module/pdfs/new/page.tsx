...
export default function NewLearningModulePdfPage() {
  ...
  const [duration, setDuration] = React.useState<LearningModulePdfDuration>("D1");
  ...
  const onSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      await learningModulePdfApi.create({
        title,
              ...
              <div className="space-y-4">
                ...
                <div className="flex flex-col gap-2 sm:flex-row sm:justify-end">
                  <Button type="button" variant="outline" asChild>
                    <Link href="/learning-module/pdfs">{t("common.cancel")}</Link>
                  </Button>
