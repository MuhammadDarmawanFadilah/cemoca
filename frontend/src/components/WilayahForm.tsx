...
export default function WilayahForm({ control, setValue, watch, disabled = false, onDataLoad }: WilayahFormProps) {
  ...
  }, [provinces.length, watchProvinsi, watchKota, watchKecamatan, regencies.length, districts.length, villages.length, onDataLoad, watchKelurahan]);
  ...
  return (
    <div className="space-y-4">
      ...
      {/* Automatic lookup loading indicator */}
      {isPerformingLookup && (
