...
@Entity
@Table(name = "learning_module_power_points")
public class LearningModulePowerPoint {
    ...
    @Column(name = "power_point_filename", length = 300)
    private String powerPointFilename;

    @Column(name = "power_point_url", columnDefinition = "LONGTEXT")
    ...
    public LearningModulePowerPoint() {
    }
    ...
    public String getPowerPointFilename() {
        return powerPointFilename;
    }

    public void setPowerPointFilename(String powerPointFilename) {
        this.powerPointFilename = powerPointFilename;
    }

    public String getPowerPointUrl() {
        return powerPointUrl;
    }

    public void setPowerPointUrl(String powerPointUrl) {
        this.powerPointUrl = powerPointUrl;
    }
